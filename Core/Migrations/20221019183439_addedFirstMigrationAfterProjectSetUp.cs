...
{
    public partial class addedFirstMigrationAfterProjectSetUp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpectedDateOfArrival = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SupplyDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExpectedPrice = table.Column<double>(type: "float", nullable: true),
                    SupplyPrice = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityBooked = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomerBookings_BookingGroups_BookingGroupId",
            ...
            migrationBuilder.CreateTable(
                name: "CustomerBookingPayments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DatePaid = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Amount = table.Column<double>(type: "float", nullable: false),
                    CustomerBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedByUserid = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBookingPayments", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomerBookingPayments_CustomerBookings_CustomerBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBookingPayments_CustomerBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBookings_BookingGroupId",
